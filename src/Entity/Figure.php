...
class Figure
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Document::class, mappedBy="figurePicture", orphanRemoval=true, cascade={"persist"})
     */
    private $picture;

    /**
     * @ORM\OneToMany(targetEntity=Document::class, mappedBy="figureVideo", orphanRemoval=true, cascade={"persist"})
     */
    private $video;
